...
. Add a new Python package to the _**pyproject.toml**_. For example, let's add the `art` package to the _**pyproject.toml**_ so we can make fancy ASCII art in our notebook.
